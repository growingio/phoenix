...
@BuiltInFunction(name = SBitMapAndNotFunction.NAME,
        args = {@Argument(allowedTypes = {PVarbinary.class}),
                @Argument(allowedTypes = {PVarbinary.class})})
public class SBitMapAndNotFunction extends ScalarFunction {

    public static final String NAME = "SBITMAP_ANDNOT";

    public SBitMapAndNotFunction() {
    }

    public SBitMapAndNotFunction(List<Expression> children) throws SQLException {
        super(children);
    }
