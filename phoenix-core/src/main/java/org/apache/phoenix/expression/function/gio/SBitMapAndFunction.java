...
@BuiltInFunction(name = SBitMapAndFunction.NAME,
        args = {@Argument(allowedTypes = {PVarbinary.class}),
                @Argument(allowedTypes = {PVarbinary.class})})
public class SBitMapAndFunction extends ScalarFunction {

    public static final String NAME = "SBITMAP_AND";

    public SBitMapAndFunction() {
    }

    public SBitMapAndFunction(List<Expression> children) throws SQLException {
        super(children);
    }
