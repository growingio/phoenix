...
@BuiltInFunction(name = BucketBitMapOrFunction.NAME,
        args = {@Argument(allowedTypes = {PVarbinary.class}),
                @Argument(allowedTypes = {PVarbinary.class})})
public class BucketBitMapOrFunction extends ScalarFunction {

    public static final String NAME = "BUCKET_BITMAP_OR";

    public BucketBitMapOrFunction() {
    }

    public BucketBitMapOrFunction(List<Expression> children) throws SQLException {
        super(children);
    }
