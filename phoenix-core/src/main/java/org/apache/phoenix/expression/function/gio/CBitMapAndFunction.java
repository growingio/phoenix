...
@BuiltInFunction(name = CBitMapAndFunction.NAME,
        args = {@Argument(allowedTypes = {PVarbinary.class}),
                @Argument(allowedTypes = {PVarbinary.class})})
public class CBitMapAndFunction extends ScalarFunction {

    public static final String NAME = "CBITMAP_AND";

    public CBitMapAndFunction() {
    }

    public CBitMapAndFunction(List<Expression> children) throws SQLException {
        super(children);
    }
