...
import org.apache.phoenix.expression.aggregator.gio.CBitMapMergeAggregator2;
...
import org.apache.phoenix.parse.gio.CBitMapMergeAggregateParseNode2;
 ...
 * @since 0.1
 */
@BuiltInFunction(name = CBitMapMergeFunction2.NAME,
        nodeClass = CBitMapMergeAggregateParseNode2.class,
        args = {@Argument(allowedTypes = {PVarbinary.class}),
                @Argument(allowedTypes = {PInteger.class})})
public class CBitMapMergeFunction2 extends DelegateConstantToCountAggregateFunction {
    public static final String NAME = "CBITMAP_MERGE2";

    public CBitMapMergeFunction2() {
    }

    // TODO: remove when not required at built-in func register time
    public CBitMapMergeFunction2(List<Expression> childExpressions) {
    ...
    public Aggregator newServerAggregator(Configuration conf, ImmutableBytesWritable ptr) {
        ...
        return new CBitMapMergeAggregator2(bmExpr.getSortOrder(), ptr, children);
    }
